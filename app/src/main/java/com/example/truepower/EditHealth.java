...
public class EditHealth extends AppCompatActivity {
    ...
    private EditText next_checkup_date, last_checkup_date, disease_name, disease_description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        disease_name = findViewById(R.id.et_disease_name);
        disease_description = findViewById(R.id.et_description);
            ...
            health.child(id).setValue(healthData).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(EditHealth.this,"Health Edit successfully",Toast.LENGTH_SHORT).show();
                        finish();
                    }else{
                        Toast.makeText(EditHealth.this,"Error",Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void displayHealthValue(){
        disease_name.setText(bundle.getString("name"));
        disease_description.setText(bundle.getString("description"));
        next_checkup_date.setText(bundle.getString("nextDate"));
        last_checkup_date.setText(bundle.getString("lastDate"));
    }
    ...
    private void loadNextCheckUpDate(){
        ...
        next_checkup_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(EditHealth.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
